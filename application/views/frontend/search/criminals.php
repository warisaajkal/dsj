			...
			<table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="50">
				...
				<tbody>
					...
					<tr class="center">
						...
						<td class="<?php if (!empty($case->old_case)) {echo 'text-danger text-strong';} ?>"> <?php if ($case->inst_date!=0000-00-00){ echo @date('d-m-Y', @strtotime($case->inst_date));} ?></td>
						<td><p class="urdu"><?php echo $case->case_title?> </p></td>
						<td><?php echo $case->plt_name; ?></td>
						<td><?php echo $case->acsd_name; ?></td>
						<td><?php if (!empty($case->offence)){ echo $case->offence; } ?></td>
						<td class="center"><?php if (!empty($case->fir_no)){ echo $case->fir_no .'/'. @date('y', @strtotime($case->fir_date)); } ?></td>
						<td class="urdu"><?php echo $case->ps_name; ?></td>
						<td style="min-width: 100px;" class="<?php if (!empty($case->nprocs)) { if($case->nprocs[$vx]->ndoh <= date("Y-m-d")){ echo 'text-warning'; } }?>"><?php if (!empty($case->nprocs)){ echo @date('d-m-Y', @strtotime( $case->nprocs[$vx]->ndoh )); } ?></td>
	      ...
	      <div class="modal-header">
		   ...
		   <table class="left table table-bordered table-hover table-left">
				<tbody>
		        	...
		        	<tr>
		        		<th rowspan="" class="">Victim's Name</th>
		        		<td colspan=""><?php echo $case->victim_name; ?></td>
		        	</tr>
		        	<tr>
		        		<th rowspan="" class="">Victim's CNIC</th>
		        		<td colspan=""><?php echo $case->victim_cnic; ?></td>
		        	</tr>
		        	<tr>
		        		<th rowspan="" class="">Victim's Address</th>
		        		<td colspan=""><?php echo $case->victim_addr; ?></td>
		        	</tr>
