...
if (!isset($court))
{
	...
	$court->teh_id='';
	$court->city_id='';
	$court->court_type='Sessions';
	$court->sorting='';
	$court->asgnd_user_id='';
	$court->status='Publish';
}
?>
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				<div class="panel-heading">
					<h3 class="panel-title">Add Name of Judge/Court</h3>
				</div>
				...
				<div class="panel-body">
					...
					<div class="form-group ">
						<div class="col-md-12">
							...
							<input type="text" value="<?php echo set_value('sorting',$court->sorting);?>" name="sorting" class="form-control" maxlength="150">
