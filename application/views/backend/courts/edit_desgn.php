...
<div class="row">
	<span style="display: block;" class="bounceIn animated">	
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				<div class="panel-heading">
					<h3 class="panel-title">Edit Designation of Judge</h3>
				</div>
				
				<div class="panel-body">
			
					<?php echo form_open(base_url('admin/courts/update_desgn'), 'class="form-horizontal"'); ?>
		
		<div class="form-group ">
			<div class="col-md-12">
				<label>Designation</label>
				<input type="text" onfocus="setEditor(this)" value="<?php echo set_value('desgn_name',$desgn->desgn_name); ?>" name="desgn_name" class="form-control" maxlength="150">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<div class="radio radio-info radio-inline">
					<input type="radio" name="status" value="Publish" id="publish" autocomplete="off" <?php if($desgn->status=='Publish'){echo 'checked';}?>>
                    <label for="publish"> Publish </label>
				</div>
                <div class="radio radio-inline">
                	<input type="radio" name="status" value="Un-Publish" id="unpublish" autocomplete="off" <?php if($desgn->status=='Un-Publish'){echo 'checked';}?>>
		...
		<div class="form-group m-b-0">
			...
			<input type="hidden" name="id" value="<?php echo set_value('id',$desgn->id); ?>">
