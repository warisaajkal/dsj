...
<div class="row">
	<span style="display: block;" class="rollIn animated">	
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				<div class="panel-heading">
					<h3 class="panel-title">Edit Tehsil Name</h3>
				</div>
				
				<div class="panel-body">
				
				<?php echo form_open(base_url('admin/tehsils/update'),'class="form-horizontal"'); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" onfocus="setEditor(this)" value="<?php echo set_value('teh_name', $item->teh_name);?>" name="teh_name" class="form-control" maxlength="150">
						<?php echo form_error('teh_name', '<div class="error">', '</div>'); ?>
						<script language="JavaScript" type=text/javascript>makeUrduEditor("teh_name", 20);</script>
				...
				<div class="form-group m-b-0">
					<div class="col-md-8 col-md-offset-4">
						<button type="submit" class="btn btn-custom btn-primary"><span class="btn-label"><i class="fa fa-save"></i></span> SAVE</button>
					</div>
				</div>
