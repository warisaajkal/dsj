		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				...
				<div class="panel-body">
					...
					<?php echo form_open(base_url('admin/categories/update'), 'class="form-horizontal"'); ?>			
							...
							<div class="form-group ">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" name="cat_reg_no" id="cat_reg_no" class="form-control" value="<?php echo set_value('cat_reg_no',$cat->cat_reg_no);?>" placeholder="ex: 4" maxlength="10">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-4">
										<input type="number" value="<?php echo set_value('sorting', $cat->sorting);?>" name="sorting" placeholder="ex: 1 " class="form-control" maxlength="50">
