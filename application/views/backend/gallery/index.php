			...
			<div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator">
				<div class="gal-detail thumb">
					...
					<p class="m-t-10 btn-group-xs text-center">
						<a class="btn btn-primary btn-custom" href="<?php echo base_url('admin/gallery/edit/'.$img->id); ?>" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fa fa-edit"></i></a>
						<a class="btn btn-danger btn-custom" href="<?php echo base_url('admin/gallery/delete/'.$img->id); ?>" onclick="return confirm('Are you sure?')" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
					</p>
				</div>
			</div>
