		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				<div class="panel-heading">
					<h3 class="panel-title">Edit Police Station</h3>
				</div>

				<div class="panel-body">
		
					<?php echo form_open(base_url('admin/police_stations/update'),'class="form-horizontal"'); ?>
			
			
						<div class="form-group ">
							<div class="col-md-12">
								<label>Police Station Name</label>
								<input type="text" onfocus="setEditor(this)" value="<?php echo set_value('ps_name', $ps->ps_name); ?>" name="ps_name" class="form-control" maxlength="150">
