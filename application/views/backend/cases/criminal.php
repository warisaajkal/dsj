			...
			<table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="50">
				...
				<tbody>
					...
					<tr class="center">
						...
						<td class="<?php if (!empty($case->nprocs)) { if($case->nprocs[$vx]->ndoh <= date("Y-m-d")){ echo 'text-warning'; } }?>"><?php if (!empty($case->nprocs)){ echo @date('d-m-Y', @strtotime( $case->nprocs[$vx]->ndoh )); } ?></td>
