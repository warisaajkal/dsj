    	...
    	<table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="50">	
			<thead>
				<tr>
					...
					<th data-hide="phone">Case Title</th>
			...
			<tbody>
				...
				<tr class="center">
					...
					<td><p class="urdu"><?php echo $case->ps_name; ?></p></td>
	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	<a class="btn btn-primary" href="<?php echo base_url('admin/cases_list/case_detail/'.$case->case_id); ?>">Print</a>
