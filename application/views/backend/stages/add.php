		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				...
				<div class="panel-body">
					...
					<?php echo form_open(base_url('admin/stages/save'), 'class="form-horizontal"'); ?>
							...
							<div class="form-group ">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" onfocus="setEditor(this)" value="<?php echo set_value('stage_name', $stage->stage_name);?>" name="stage_name" placeholder="" class="form-control" maxlength="150">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-4">
										<input type="number" value="<?php echo set_value('sorting', $stage->sorting);?>" name="sorting" placeholder="i.e. 1 " class="form-control" maxlength="50">
