		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-color panel-custom">
				...
				<div class="panel-body">
					...
					<?php echo form_open(base_url('admin/stages_cause_list/update'), 'class="form-horizontal"'); ?>
					...
					<?php endif; ?>
						...
						<div class="form-group m-b-0">
							<div class="col-md-8 col-md-offset-4">
								<button type="submit" class="btn btn-custom btn-primary btn-rounded btn-lg"><span class="btn-label"><i class="fa fa-save"></i></span> Update</button>
							</div>
						</div>
						
						<?php if (!$this->ion_auth->is_Admin()) : ?>
							<input type="hidden" name="court_id" value="<?php echo $item->court_id; ?>">
						<?php endif; ?>
